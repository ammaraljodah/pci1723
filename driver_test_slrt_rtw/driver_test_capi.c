...
static const rtwCAPI_BlockParameters rtBlockParameters[] = {
   ...
   */
  { 1, TARGET_STRING("Constant1"),
    TARGET_STRING("Value"), 0, 0, 0 },

  { 2, TARGET_STRING("Gain"),
    TARGET_STRING("Gain"), 0, 0, 0 },

  { 3, TARGET_STRING("S-Function"),
    TARGET_STRING("P1"), 0, 1, 0 },

  { 4, TARGET_STRING("S-Function"),
    TARGET_STRING("P2"), 0, 1, 0 },

  { 5, TARGET_STRING("S-Function"),
...
static void* rtDataAddrMap[] = {
  &driver_test_B.Gain,                 /* 0: Signal */
  &driver_test_P.Constant1_Value,      /* 1: Block Parameter */
  &driver_test_P.Gain_Gain,            /* 2: Block Parameter */
  &driver_test_P.SFunction_P1[0],      /* 3: Block Parameter */
  &driver_test_P.SFunction_P2[0],      /* 4: Block Parameter */
  &driver_test_P.SFunction_P3[0],      /* 5: Block Parameter */
  &driver_test_P.SFunction_P4,         /* 6: Block Parameter */
  &driver_test_P.SFunction_P5,         /* 7: Block Parameter */
  &driver_test_P.SFunction_P6,         /* 8: Block Parameter */
};
