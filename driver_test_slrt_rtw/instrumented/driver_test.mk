...
MODEL           = driver_test
MODULES         = rt_matrx.c rt_printf.c rt_logging.c driver_test_capi.c driver_test_data.c driver_test_xcp.c driver_test_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = driver_test.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\labadmin\Desktop\testdriver\pci1723
S_FUNCTIONS     = advantechpci1723.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\labadmin\AppData\Roaming\MathWorks\MATLAB\R2017b\mex_C_win64.xml"
...
MODELLIB                  = driver_testlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = driver_test_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\driver_test_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
